...
namespace Курсовая_Имитация_банкомата_
{
    public partial class RecognitionRus : Form
    {
        public RecognitionRus()
        {
            ...
            progressBar1.Value = 0; ////Задаем изначальное значение progressBar1
            timer2.Enabled = true; //Включаем таймер
            timer2.Interval = 7500; //Задаем интервал таймера
            label1.Text = "Пожалуйста , подождите... Идет процесс распознавания карты!"; //Присваиваем label1 текст
