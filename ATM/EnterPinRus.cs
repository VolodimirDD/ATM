...
namespace Курсовая_Имитация_банкомата_
{
    public partial class EnterPinRus : Form
    {
        public EnterPinRus()
        {
            ...
            // Инициализация компонентов и настройка формы
            ...
            label2.Text = "Введите ваш pin-код!";
            enter.Select();
        }
        ...
        private void enter_Click_1(object sender, EventArgs e)
        {
            if ((pinkod.Text.Length > 4) || (pinkod.Text.Length < 4))
            {
                ...
                label1.Text = $"Введите корректный pin! Осталось попыток: {remainingAttempts}";
            }
            else
            {
                if (pinkod.Text == "1111")
                ...
                else
                {
                    ...
                    {
                        label1.Text = $"Неверный PIN-code. Осталось попыток: {remainingAttempts}";
                        pinkod.Text = "";
                    }
                    else
                    {
